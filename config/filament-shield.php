    ...
    */
    ...
    'resources' => [
        ...
        'manage' => [
            ...
            \App\Filament\Resources\InputNilais\InputNilaiResource::class => [
                'viewAny',
                'view',
                'create',
                'update',
            ...
            \App\Filament\Resources\RekapNilais\RekapNilaiResource::class => [
                'viewAny',
                'view',
                'create',
                'update',
            ...
            \App\Filament\Resources\NilaiSikaps\NilaiSikapResource::class => [
                'viewAny',
                'view',
                'create',
                'update',
            ...
            // ✅ TAMBAHKAN INI untuk RekapNilaiSikap
            \App\Filament\Resources\RekapNilaiSikaps\RekapNilaiSikapResource::class => [
                'viewAny',
                'view',
                'create',
                'update',
